class ZCX_FAULT_RESPONSE_OUT definition
  public
...
public section.
  ...
  data ADDITION type ZRESULT_ERROR read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !ADDITION type ZRESULT_ERROR optional
...
CLASS ZCX_FAULT_RESPONSE_OUT IMPLEMENTATION.
