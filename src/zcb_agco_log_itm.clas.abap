class ZCB_AGCO_LOG_ITM definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      !I_TRACKING_ID type ZDEMM_AGCO_TRACKING_ID
      !I_ITEM type ZDEMM_AGCO_ITEM
      !I_POINTER type ZDEMM_AGCO_POINTER optional
      !I_VALUE type ZDEMM_AGCO_VALUE optional
      !I_DETAIL type ZDEMM_AGCO_DETAIL optional
      !I_ERROR_CODE type ZDEMM_AGCO_ERROR_CODE optional
    returning
      value(RESULT) type ref to ZCL_AGCO_LOG_ITM
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_AGCO_LOG_ITM .
  types:
    begin of TYP_BUSINESS_KEY ,
      TRACKING_ID type ZDEMM_AGCO_TRACKING_ID ,
      ITEM type ZDEMM_AGCO_ITEM ,
  ...
  types:
    begin of TYP_DB_DATA ,
      TRACKING_ID type ZDEMM_AGCO_TRACKING_ID ,
      ITEM type ZDEMM_AGCO_ITEM ,
      POINTER type ZDEMM_AGCO_POINTER ,
      VALUE type ZDEMM_AGCO_VALUE ,
      DETAIL type ZDEMM_AGCO_DETAIL ,
      ERROR_CODE type ZDEMM_AGCO_ERROR_CODE ,
    end of TYP_DB_DATA .
  types:
...
CLASS ZCB_AGCO_LOG_ITM IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_TRACKING_ID TYPE ZDEMM_AGCO_TRACKING_ID
*      IMPORTING I_ITEM TYPE ZDEMM_AGCO_ITEM
*      IMPORTING I_POINTER TYPE ZDEMM_AGCO_POINTER
*      IMPORTING I_VALUE TYPE ZDEMM_AGCO_VALUE
*      IMPORTING I_DETAIL TYPE ZDEMM_AGCO_DETAIL
*      IMPORTING I_ERROR_CODE TYPE ZDEMM_AGCO_ERROR_CODE
*      RETURNING RESULT TYPE REF TO ZCL_AGCO_LOG_ITM
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-TRACKING_ID = I_TRACKING_ID.
  BUSINESS_KEY-ITEM = I_ITEM.
*>
...
*<  Generated from mapping:
          THE_OBJECT->TRACKING_ID = I_TRACKING_ID.
          THE_OBJECT->ITEM = I_ITEM.
          THE_OBJECT->POINTER = I_POINTER.
          THE_OBJECT->VALUE = I_VALUE.
          THE_OBJECT->DETAIL = I_DETAIL.
          THE_OBJECT->ERROR_CODE = I_ERROR_CODE.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_TRACKING_ID = BUSINESS_KEY-TRACKING_ID
                 I_ITEM = BUSINESS_KEY-ITEM
...
*<Generated from mapping:
  E_BUSINESS_KEY-TRACKING_ID  = I_DB_DATA-TRACKING_ID.
  E_BUSINESS_KEY-ITEM  = I_DB_DATA-ITEM.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_AGCO_LOG_ITM,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-TRACKING_ID = THE_OBJECT->TRACKING_ID.
    OBJECT_DATA_ITEM-ITEM = THE_OBJECT->ITEM.
    OBJECT_DATA_ITEM-POINTER = THE_OBJECT->POINTER.
    OBJECT_DATA_ITEM-VALUE = THE_OBJECT->VALUE.
    OBJECT_DATA_ITEM-DETAIL = THE_OBJECT->DETAIL.
    OBJECT_DATA_ITEM-ERROR_CODE = THE_OBJECT->ERROR_CODE.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'TRACKING_ID'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZMM_AGCO_LOG_ITM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'TRACKING_ID'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ITEM'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZMM_AGCO_LOG_ITM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ITEM'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'POINTER'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZMM_AGCO_LOG_ITM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'POINTER'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'VALUE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZMM_AGCO_LOG_ITM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'VALUE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'DETAIL'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZMM_AGCO_LOG_ITM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'DETAIL'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ERROR_CODE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZMM_AGCO_LOG_ITM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ERROR_CODE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_AGCO_LOG_ITM.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->TRACKING_ID,
             THE_OBJECT->ITEM,
             THE_OBJECT->POINTER,
             THE_OBJECT->VALUE,
             THE_OBJECT->DETAIL,
             THE_OBJECT->ERROR_CODE.
*>
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZMM_AGCO_LOG_ITM.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZMM_AGCO_LOG_ITM> type ZMM_AGCO_LOG_ITM.
*>

*< Generated from mapping:
  select * from ZMM_AGCO_LOG_ITM
           up to I_UPTO rows
...
*   * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZMM_AGCO_LOG_ITM'
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZMM_AGCO_LOG_ITM>.

*< Generated from mapping:
    DB_DATA-TRACKING_ID = <FS_DB_ZMM_AGCO_LOG_ITM>-TRACKING_ID.
    DB_DATA-ITEM = <FS_DB_ZMM_AGCO_LOG_ITM>-ITEM.
    DB_DATA-POINTER = <FS_DB_ZMM_AGCO_LOG_ITM>-POINTER.
    DB_DATA-VALUE = <FS_DB_ZMM_AGCO_LOG_ITM>-VALUE.
    DB_DATA-DETAIL = <FS_DB_ZMM_AGCO_LOG_ITM>-DETAIL.
    DB_DATA-ERROR_CODE = <FS_DB_ZMM_AGCO_LOG_ITM>-ERROR_CODE.
*>
...
*< Generated from mapping:
  select * from ZMM_AGCO_LOG_ITM
           ...
           where ZMM_AGCO_LOG_ITM~TRACKING_ID =
           I_BUSINESS_KEY_TAB-TRACKING_ID
             and ZMM_AGCO_LOG_ITM~ITEM = I_BUSINESS_KEY_TAB-ITEM.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-TRACKING_ID = BUSINESS_KEY-TRACKING_ID.
    <FS_OBJECT_DATA>-ITEM = BUSINESS_KEY-ITEM.
*>
...
* * ZMM_AGCO_LOG_ITM: internal tables for mass operation
  data DB_ITB_ZMM_AGCO_LOG_ITM type STANDARD TABLE OF ZMM_AGCO_LOG_ITM.
  data DB_UTB_ZMM_AGCO_LOG_ITM type STANDARD TABLE OF ZMM_AGCO_LOG_ITM.
  data DB_DTB_ZMM_AGCO_LOG_ITM type STANDARD TABLE OF ZMM_AGCO_LOG_ITM.

* * ZMM_AGCO_LOG_ITM: headlines for tables
  data DB_ILN_ZMM_AGCO_LOG_ITM type ZMM_AGCO_LOG_ITM.
  data DB_ULN_ZMM_AGCO_LOG_ITM type ZMM_AGCO_LOG_ITM.
  data DB_DLN_ZMM_AGCO_LOG_ITM type ZMM_AGCO_LOG_ITM.
...
*< Generated from mapping:
   ...
   DB_ILN_ZMM_AGCO_LOG_ITM-POINTER = <FS_INSERT>-POINTER.
   DB_ILN_ZMM_AGCO_LOG_ITM-VALUE = <FS_INSERT>-VALUE.
   DB_ILN_ZMM_AGCO_LOG_ITM-DETAIL = <FS_INSERT>-DETAIL.
   DB_ILN_ZMM_AGCO_LOG_ITM-ERROR_CODE = <FS_INSERT>-ERROR_CODE.


   DB_ILN_ZMM_AGCO_LOG_ITM-TRACKING_ID = <FS_INSERT>-TRACKING_ID.
   DB_ILN_ZMM_AGCO_LOG_ITM-ITEM = <FS_INSERT>-ITEM.
   append DB_ILN_ZMM_AGCO_LOG_ITM to DB_ITB_ZMM_AGCO_LOG_ITM.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZMM_AGCO_LOG_ITM-POINTER = <FS_UPDATE>-POINTER.
   DB_ULN_ZMM_AGCO_LOG_ITM-VALUE = <FS_UPDATE>-VALUE.
   DB_ULN_ZMM_AGCO_LOG_ITM-DETAIL = <FS_UPDATE>-DETAIL.
   DB_ULN_ZMM_AGCO_LOG_ITM-ERROR_CODE = <FS_UPDATE>-ERROR_CODE.


   DB_ULN_ZMM_AGCO_LOG_ITM-TRACKING_ID = <FS_UPDATE>-TRACKING_ID.
   DB_ULN_ZMM_AGCO_LOG_ITM-ITEM = <FS_UPDATE>-ITEM.
   append DB_ULN_ZMM_AGCO_LOG_ITM TO DB_UTB_ZMM_AGCO_LOG_ITM.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZMM_AGCO_LOG_ITM-TRACKING_ID =
    <FS_DELETE>-BUSINESS_KEY-TRACKING_ID.
    DB_DLN_ZMM_AGCO_LOG_ITM-ITEM = <FS_DELETE>-BUSINESS_KEY-ITEM.

    append DB_DLN_ZMM_AGCO_LOG_ITM TO DB_DTB_ZMM_AGCO_LOG_ITM.
...
* * DB Deletes
  delete ZMM_AGCO_LOG_ITM FROM TABLE DB_DTB_ZMM_AGCO_LOG_ITM.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZMM_AGCO_LOG_ITM'.
  endif.

* * DB Inserts
  insert ZMM_AGCO_LOG_ITM FROM TABLE DB_ITB_ZMM_AGCO_LOG_ITM
...
* * DB Updates
  update ZMM_AGCO_LOG_ITM FROM TABLE DB_UTB_ZMM_AGCO_LOG_ITM.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-TRACKING_ID.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-ITEM.
  concatenate RESULT COMP_STRING into RESULT.
*>
...
*<  Generated from mapping:
  THE_OBJECT->TRACKING_ID = I_OBJECT_DATA-TRACKING_ID.
  THE_OBJECT->ITEM = I_OBJECT_DATA-ITEM.
  THE_OBJECT->POINTER = I_OBJECT_DATA-POINTER.
  THE_OBJECT->VALUE = I_OBJECT_DATA-VALUE.
  THE_OBJECT->DETAIL = I_OBJECT_DATA-DETAIL.
  THE_OBJECT->ERROR_CODE = I_OBJECT_DATA-ERROR_CODE.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_AGCO_LOG_ITM.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->TRACKING_ID = I_BUSINESS_KEY-TRACKING_ID.
  NEW_OBJECT->ITEM = I_BUSINESS_KEY-ITEM.
* >
